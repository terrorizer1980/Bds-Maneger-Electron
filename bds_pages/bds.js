...
if (process.platform == 'win32'){
    ...
    var bdsFound = exec(`if [ -d bds/ ];then if [ -e bds/bedrock_server ];then echo 'exist';exit 0;else echo 'not exist software'; exit 1;fi; else echo 'not exist foud'; exit 1; fi`, {detached: false,shell: true});
}
